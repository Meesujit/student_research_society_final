// import Link from 'next/link'
 ...
 const Footer = () => {
  return (
    ...
    <footer className=" py-12 px-4 sm:px-6 lg:px-8 font-mono" id="contact">
      <div className="max-w-7xl mx-auto mt-10">
        ...
        <div className="mt-12 flex flex-col sm:flex-row justify-between items-center">
          ...
          <p className="text-gray-500 text-sm">Copyright © 2024 Kalinga Institute of Industrial Technology (KIIT)</p>
        </div>
      </div>
    </footer>
    </>
